...
aliases:
  - Codex Skill、Plugin、MCP 与 Superpowers
  - Codex 扩展机制
  - Skill 与 Plugin
---
...
> - 前置阅读：[[AI 开发/Agent 工程/Codex/Codex 规则如何生效|Codex 规则如何生效]]、[[AI 开发/Agent 工程/Codex/多个项目如何复用 Codex 规则|多个项目如何复用 Codex 规则]]
> - 本文目标：区分 Codex 的规则、工作流、连接能力和分发机制
> - 返回主线：[[AI 开发/index|AI 开发知识地图]]

## 1. 四种机制的职责

本文为产品选读。通用关系先看 [[AI 开发/基础概念/AI 开发核心概念|行动与编排的核心概念]]；以下产品说明于 2026 年 9 月 15 日核对，Superpowers 行为仅指本文标明的本机版本。
...
- 生命周期 hooks：在配置的运行节点执行命令，支持范围和脚本运行环境需按具体产品核对。
